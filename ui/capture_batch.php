...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .card{background:#0f172a;border:1px solid #24304a;border-radius:12px;overflow:hidden;margin-bottom:12px}
    .head{padding:12px;border-bottom:1px solid #24304a;display:flex;gap:8px;flex-wrap:wrap}
    .input{flex:1;min-width:160px;padding:10px 12px;border-radius:10px;border:1px solid #334155;background:#0b1220;color:#e6edf3}
    ...
    video,canvas,img{width:100%;max-height:55vh;background:#000;border-radius:10px}
    .toolbar{display:flex;gap:8px;justify-content:center;align-items:center;padding:10px;border-top:1px solid #24304a}
    .hint{font-size:12px;color:#94a3b8;text-align:center;margin:6px 0}
    .thumbs{display:grid;grid-template-columns:repeat(3,1fr);gap:8px}
    .thumb{border:1px solid #24304a;border-radius:10px;overflow:hidden;background:#0b1220}
    .thumb img{width:100%;height:120px;object-fit:cover;display:block}
    .thumb .controls{display:flex;gap:6px;justify-content:space-between;padding:6px}
    ...
    .progress{height:10px;background:#182239;border:1px solid #24304a;border-radius:999px;overflow:hidden}
...
<body>
  ...
  <div class="wrap">
    ...
    <p class="hint">Semua pengolahan berat (simpan file dan pembuatan PDF) dilakukan di server. Halaman ini hanya menangkap dan mengirim foto secara sekuensial.</p>
  </div>
